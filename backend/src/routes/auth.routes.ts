...
const refreshLimiter = rateLimit({ windowMs: 15 * 60_000, limit: 120, skip: () => env.NODE_ENV === "test", standardHeaders: "draft-8", legacyHeaders: false, message: { success: false, message: "Demasiadas solicitudes de sesión. Probá nuevamente más tarde.", code: "RATE_LIMITED" } });
